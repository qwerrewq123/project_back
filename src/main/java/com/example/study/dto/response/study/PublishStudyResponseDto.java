...
public class PublishStudyResponseDto extends ResponseDto {

    private PublishStudyResponseDto(){
        super();
    }

    public static ResponseEntity<PublishStudyResponseDto> success(){
        PublishStudyResponseDto responseBody = new PublishStudyResponseDto();
